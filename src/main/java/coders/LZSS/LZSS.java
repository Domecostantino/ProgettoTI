 ...
 * 
 * Keep a ring buffer which initially contains all space characters.
 * Read several letters from the file to the buffer.
 * Search the buffer for the longest string that matches the letters just
